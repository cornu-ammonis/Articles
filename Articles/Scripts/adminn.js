$(function () {
  ...
  //************************* POSTS GRID
  Articles.GridManager.postsGrid = function (gridName, pagerName) {
    ...
    var addOptions = {
      ...
      onClose: onClose,
      afterSubmit: Articles.GridManager.afterSubmitHandler,
  ...
  //************************* CATEGORIES GRID
  Articles.GridManager.categoriesGrid = function (gridName, pagerName) {
  ...
  //************************* TAGS GRID
  Articles.GridManager.tagsGrid = function (gridName, pagerName) {
    var colNames = ['Id', 'Name', 'Url Slug', 'Description'];
  ...
  Articles.GridManager.afterSubmitHandler = function (response, postdata) {
  ...
  $("#tabs").tabs({
    show: function (event, ui) {
      ...
      if (!ui.tab.isLoaded) {
        ...
        var gdMgr = Articles.GridManager,
